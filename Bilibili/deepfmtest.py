...
tf.app.flags.DEFINE_integer("feature_size", 198, "Number of features")
tf.app.flags.DEFINE_integer("field_size", 8, "Number of fields")
...
tf.app.flags.DEFINE_string("data_dir", '/Users/monarch/Desktop/', "/Users/monarch/Desktop/")
...
def main(_):
    ...
    tr_files = getFileList("data/train/")
    ...
    #te_files = getFileList("data/test/")
